#include "SizePriority.h"

namespace SizePriority {
    const std::vector<std::string> MEN_TEXTILE{
        "M", "L", "S", "XL", "XS", "2XL", "2XS"
    };

    const std::vector<std::string> MEN_PANTS{
        "48", "50", "46", "52", "48S", "50S", "46S", "44", "54", "44S", "52S", "56"
    };

    const std::vector<std::string> MEN_JEANS{
        "32", "33", "34", "31", "30", "36", "38", "28", "35", "40"
    };

    const std::vector<std::string> WOMEN_TEXTILE{
        "S", "M", "XS", "L", "XL", "2XS", "2XL"
    };

    const std::vector<std::string> WOMEN_BRA{
        "MCD", "SCD", "MAB", "SAB", "LCD", "LAB", "XSCD", "XSAB", "XLCD", "XLAB",
        "MEG", "LEG", "SEG", "XLEG", "2XCD", "2XAB", "2XSCD", "2XSAB", "3XCD",
        "2XEG", "3XEG", "4XEG", "XSEG"
    };

    const std::vector<std::string> WOMEN_JEANS_1{
    ...
    const std::vector<std::string> WOMEN_JEANS_2{
        "38", "40", "36", "42", "44", "34", "46", "32", "30", "48", "28"
    };

    const std::vector<std::string> KIDS_TEXTILE_1{
        "74", "80", "86", "68", "92", "98", "62", "104"
    };

    const std::vector<std::string> KIDS_TEXTILE_2{
        "128", "140", "116", "152", "110", "164", "104", "170"
    };

    const std::vector<std::string> KIDS_TEXTILE_3{
        "140", "152", "164", "128", "116", "176", "104"
    };

    const std::vector<std::string> KIDS_TEXTILE_4{
        "110", "116", "122", "104", "128", "98", "140", "92"
    };

    const std::vector<std::string> KIDS_TEXTILE_5{
        "146", "152", "158", "140", "164", "128", "176"
    };

    const std::vector<std::string> MEN_FOOTWEAR{
        "8-", "8", "9", "9-", "10", "10-", "7", "7-", "11", "11-", "6", "6-",
        "12", "12-", "13", "13-", "14"
    };

    const std::vector<std::string> MEN_UNISEX_FOOTWEAR{
        "8-", "8", "9", "9-", "10", "10-", "11", "11-", "12", "12-", "13", "13-", "14"
    };

    const std::vector<std::string> WOMEN_FOOTWEAR{
        "5-", "5", "6", "6-", "4", "4-", "7", "7-", "8", "8-", "3-", "3"
    };

    const std::vector<std::string> WOMEN_UNISEX_FOOTWEAR{
        "5-", "5", "6", "6-", "4", "4-", "7", "7-", "3-", "3"
    };

    const std::vector<std::string> UNISEX_FOOTWEAR{
        "5-", "5", "6", "6-", "4", "4-", "7", "7-", "8", "8-", "3-", "3",
        "8", "8-", "9", "9-", "10", "10-", "7", "7-", "11", "11-", "6", "6-",
        "12", "12-", "13", "13-", "14"
    };

    const std::vector<std::string> KIDS_FOOTWEAR_1{
        "32", "33", "33-", "34", "35", "3", "3-", "4", "4-", "5", "5-", "31",
        "31-", "30", "30-", "29", "28", "28-"
    };

    const std::vector<std::string> KIDS_FOOTWEAR_2{
        "22", "23", "23-", "24", "25", "25-", "21", "26", "26-", "20", "27", "19"
    };

    const std::vector<std::string> KIDS_FOOTWEAR_3{
        "18", "19", "20", "17", "21", "16"
    };
